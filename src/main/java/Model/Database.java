    ...
    public ArrayList<List<String>> read(IEntity entity, String searchName,String searchFor){
        ...
        try (Connection conn = this.connect();
            ...
            for (int j = 0; rs.next(); j++) {
                return_list.add(new ArrayList<String>());
...
//            }
    ...
    public boolean isExist(IEntity entity) {
        boolean res;
        String sql = "SELECT" + " " + entity.getPrimaryKeyName() + " " + "FROM" + " " + entity.GetTableName() +" "+
    ...
    public void delete(IEntity entity){
        String sql = "DELETE FROM"+" "+entity.GetTableName()+" "+"WHERE"+" "+entity.getPrimaryKeyName()+"="+"?";
...
//
    public void update(IEntity entity){
        ...
        String sql ="UPDATE"+" "+entity.GetTableName()+" "+"SET"+" "+query+" "+"WHERE"+" "+entity.getPrimaryKeyName()+" "+"="
...
//            pstmt.setString(i+1,entity.getPrimaryKeyName());
    ...
    public int getMax(IEntity entity){
        String SQL ="select max("+entity.getPrimaryKeyName()+")"+" " +"FROM "+entity.GetTableName();
        int max=0;
